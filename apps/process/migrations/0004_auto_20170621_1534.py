...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='unit',
            field=models.CharField(choices=[('m2', 'm2'), ('m3', 'm3'), ('che', '车'), ('ton', 'ton')], default=1, max_length=4, verbose_name='单位'),
            preserve_default=False,
        ),
        ...
        migrations.AlterField(
            model_name='ksorderitem',
            name='unit',
            field=models.CharField(choices=[('m2', 'm2'), ('m3', 'm3'), ('che', '车'), ('ton', 'ton')], max_length=4, verbose_name='单位'),
        ),
        migrations.AlterField(
            model_name='mborderitem',
            name='amount',
