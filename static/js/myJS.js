...
function gogo_slab_list(block_num, thickness, ids, url, type = '') {
    // var slab_ids = ids
    var _ids = arguments[2] ? arguments[2] : block_num
    console.log(url)
    console.log(block_num, thickness)
    // var thickness =thickness
    // var block_num = block_num
    // var _ids = (ids==null)?block_num:ids
    var _url = url + "?block_num=" + block_num + "&thickness=" + thickness + "&ids=" + _ids +"&type="+type;
